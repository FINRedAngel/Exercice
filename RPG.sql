...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 11 oct. 2021 à 16:20
...
-- use exo1;
-- create table jeux(
--  identifiant int PRIMARY KEY NOT NULL AUTO_INCREMENT,
-- 	nom varchar(40));

-- INSERT INTO `jeux` (`identifiant`, `nom`) VALUES
-- 	(1, 'Monopoly'),
-- 	(2, 'Trivial');
...
(4, 'Mage', 2, 3, 6, 'Classe Magique, Spécialiste de la magie de combat et soutien');
...
--
ALTER TABLE `personnage`
  MODIFY `idPersonnage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
